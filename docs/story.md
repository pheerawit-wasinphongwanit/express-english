...
| T3 | นักแปลฝึกหัด 📖 | ภูมิใจ | 900–1,799 | ถึง W3 มั่นคง |
| T4 | วิศวกรสายด่วน ⚡ | มันส์สุดขีด | 1,500–2,599 | W4 + streak ≥ 20 |
| T5 | หัวรถจักรสองภาษา 🚂 | ตำนาน | ≥ 2,600 | W4 + streak ≥ 35 (mult 8) |
...
→ W2 (open) → [≥500] → W3 (open — context เข้ามา) → [≥1,200] → W4 (open, จนเวลาหมด)
...
| 3 ทางแยก | อ่านบริบทจริง | จับคำผิด 20% · เติมคำ 15% · คำศัพท์ 35% · **context 30%** | context โผล่ (+8 วิ/ข้อ) |
...
|---|---|---|---|---|---|
| timeBank | เวลาคงเหลือ | 45 วิ | [0, **50**] | ถูก +wReward (context +8) · ผิด −5 · milestone +6 · ไหล −1/วิ | จบเกมที่ 0 · แถบเวลา |
...
| wave | สถานีปัจจุบัน | 1 | [1,4] | score ผ่าน gate 150/500/1,200 | mix · reward |
...
| "ผู้ใหญ่สายภาษา" | W1–W4 แม่น streak 40+ mult 8 · context กิน +8 วิช่วยต่อ run | W4: 320/ข้อ · ~2,750 · ~115 วิ | T5 ✓ + สถิติใหม่ ★ |
