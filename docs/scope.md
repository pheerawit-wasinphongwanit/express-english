...
| 2 | ป.4–6 (A2) | +3 วิ | คะแนน ≥ 150 |
| 3 | ม.ต้น (B1) | +2 วิ · context +8 วิ | ≥ 500 |
| 4 ปลายทาง | ม.ปลาย+ (B1+/B2) | +1 วิ · context +8 วิ | ≥ 1,200 |

- เริ่ม run: เวลา **45 วิ** · ผิด: −5 วิ + รีเซ็ตสตรีค · milestone ทุก 10 ถูกติด: +6 วิ + โบนัส 50×wave · เพดานเวลา 50 วิ
- คะแนน/ข้อ = 10 × wave × multiplier · multiplier = 1 + ⌊streak/5⌋ สูงสุด 8 · tier T1–T5 คงเกณฑ์ด่วนคณิต (<300 / 300–899 / 900–1,799 / 1,500–2,599 / ≥2,600)
- **Tuning knobs (ปรับได้หลัง playtest โดยไม่ถือว่าแก้สัญญา):** เวลาต้น run 45→50 · reward ต่อ wave · context +8 · gate 150/500/1,200 · เกณฑ์ tier — ทุกตัวต้องผ่าน self-test + playtest ยืนยันกรอบ 60–120 วิ
...
- [ ] Time-bank 45 / +1–4 (+8 context) / −5 / milestone +6 — run จริงอยู่ใน 60–120 วิ (playtest ยืนยัน)
- [ ] Multiplier 1→8 ทุก 5 ถูกติด · รีเซ็ตเมื่อผิด · wave gates 150/500/1,200 · tier T1–T5 ทำงานถูก
